...
{	
	...
	[[
		...
		{
			float fMinAlpha = 0.02f;
			float fAlpha = clamp (0.08f - abs( v.vPos.x / 4700.f) - abs( v.vPos.y / 4700.f), 0.02f, 0.08f); // 'clamp' sets the min value to 0.06 and max to 0.21,'abs' gets rid of the minus,'info' command shows coordinates in the game.#0.02f;
